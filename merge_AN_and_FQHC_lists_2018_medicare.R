...
## FQHC
fqhcdir <- input_dir("E:/CT_APCD/Sai/MedicareProvider_ Lists_2018_2019/2018Lists_ForAttribution/2018Lists_ForAttribution/FQHC_Commercial_Medicare_2018/")
...
fqhc2 <-data.table(readxl::read_excel(paste0(fqhcdir, 
                                           "CHSHartford_2018_FinalForAttribution.xlsx")))
names(fqhc2)
...
fqhc3 <-data.table(readxl::read_excel(paste0(fqhcdir, 
                                           "CHWTorrington_Provider Listing 2018_FinalForAttribution.xls")))
names(fqhc3)
...
fqhc4 <-data.table(readxl::read_excel(paste0(fqhcdir, 
                                           "CIFC Danbury_HealthCare Quality Scorecard_2018_FinalForAttribution.xlsx")))
names(fqhc4)
...
fqhc5 <-data.table(readxl::read_excel(paste0(fqhcdir, 
                                             "CornellScottHC Medical Providers 2018_FinalForAttribution.xlsx")))
...
fqhc6 <-data.table(readxl::read_excel(paste0(fqhcdir, 
                                           "FairhavenProvider List 2018_FinalForAttribution.xlsx")))
names(fqhc6)
...
fqhc8 <-data.table(readxl::read_excel(paste0(fqhcdir, 
                                           "Generations_2018_FinalForAttribution.xlsx")))
names(fqhc8)
...
fqhc11 <-data.table(read_excel(paste0(fqhcdir, 
                                    "Norwalk_2018_FinalForAttribution.xlsx")))
names(fqhc11)
...
fqhc12 <-data.table(read_excel(paste0(fqhcdir, 
                                    "OptimusProvider List 2018_FinalForAttribution.xlsx")))
names(fqhc12)
...
fqhc13 <-data.table(read_excel(paste0(fqhcdir, 
                                    "SouthwestCHC providers List_2018_FinalForAttribution.xlsx")))
names(fqhc13)
...
fqhc14 <-data.table(read_excel(paste0(fqhcdir, 
                                    "StaywellOnline Healthcare Quality Scorecard Provider Lists_2018_FinalForAttribution.xlsx")))
names(fqhc14)
...
fqhc15 <-data.table(read_excel(paste0(fqhcdir, 
                                    "UCFSHealthcare_2018._FinalForAttribution.xlsx")))
names(fqhc15)
...
fqhc16 <-data.table(read_excel(paste0(fqhcdir, 
                                    "Wheeler_2018_FinalForAttribution.xlsx")))
names(fqhc16)
...
## AN
andir <- input_dir("E:/CT_APCD/Sai/MedicareProvider_ Lists_2018_2019/2018Lists_ForAttribution/2018Lists_ForAttribution/AN_Medicare_2018/")
...
an17 <-data.table(read_excel(paste0(andir, 
                                    "WCHN_Medicare_2018_FinalForAttribution.xlsx")))
names(an17)
...
fwrite(dat_wide, 
       file = paste0(outdir, "NPI_WholeSet_2018_mc.csv"))

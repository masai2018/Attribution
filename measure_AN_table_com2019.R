...
dir.in <- input_dir('E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/measure_AN_2019/detail/')
dir.in2 <- input_dir("E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/Double-Attribution_2019/")
dir.out.tb <- output_dir('E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/measure_AN_2019/table/')
...
for (measureName in measurelist){
  ...
  if (measureName %in% measurelist_lowerbetter){
    measure[!is.na(EntityID) & denom >= 30 & EntityID != "ZZ", `:=`(score = 1 - score,
                                   ...
                                   measure.top_performe_AN = 1 - measure.top_performer_AN)]
  }

...
dir.in <- input_dir('E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/measure_AN_2017/detail/')
dir.in2 <- input_dir("E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/Double-Attribution_2017/")
dir.out.tb <- output_dir('E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/measure_AN_2017/table/')
...
Attri2_final <- fread(paste0(dir.in2, 'Attri2_final.csv'),
                      ...
                      nrows = 1)
entityNameList <- names(Attri2_final)[11:28]
...
for (measureName in measurelist){
  ...
  if (measureName %in% measurelist_lowerbetter){
    measure[!is.na(EntityID) & denom >= 30 & EntityID != "ZZ", `:=`(score = 1 - score,
                                   ...
                                   measure.top_performer = 1 - measure.top_performer,
                                   measure.top_performer_AN = 1 - measure.top_performer_AN)]
  }

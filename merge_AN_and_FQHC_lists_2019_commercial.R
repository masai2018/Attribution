...
## AN
andir <- input_dir("E:/CT_APCD/Sai/CommercialProvider_ Lists_2018_2019/2019Lists_ForAttribution/")
...
an17 <-data.table(read_excel(paste0(andir, 
                                    "WesternCTHealthNetwork_Commercial_2019_FinalForAttribution.xlsx")))
names(an17)
...
fwrite(dat_wide, 
       file = paste0(outdir, "NPI_WholeSet_2019_com.csv"))

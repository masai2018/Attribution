...
dir.in <- input_dir('E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/Double-Attribution_2017/')
# dir.out <- 'E:/CT_APCD/Hongfei/output/measure_AN/'
dir.out <- output_dir('E:/CT_APCD/Sai/lds2021/lds2021file/Attribution_result/output/measure_AN_2017/detail/')
...
for (measureName in measurelist){
  ...
  for (entityName in c(entityNameList, 
    ...
    if (measureName %in% c('2017FUH_30d',
                           '2017FUH_7d')){
      ANrate.out <- rbind(
        ANrate.out,
        data.table(matrix(c(
